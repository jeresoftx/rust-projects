...
- [x] #19 Escribir capítulo, diagrama, ejemplos y ejercicios de SQLite.

### Git

- [x] #20 Especificar objetos, índice, referencias y límites de Git educativo.
- [ ] #21 Implementar y probar Git educativo.
- [x] #22 Escribir capítulo, diagrama, ejemplos y ejercicios de Git.
...
- [x] #25 Escribir capítulo, diagrama, ejemplos y ejercicios de Docker.
...
- [x] #32 Completar ruta de lectura, glosario y auditoría editorial en `draft`.
